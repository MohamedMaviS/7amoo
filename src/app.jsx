...
/* KICK_USER is declared once in sections.jsx (loaded first) and shared
   via global script scope — do not redeclare it here. */
    ...
    <div className={`kpv ${show?'show':''}`} style={{top:pos.top,left:pos.left}} aria-hidden={!show}>
      <div className="kpv__v">
        {mount && <iframe key={`k-${muted?'m':'u'}-${Math.round(vol*10)}`}
          ...
          title="7amoo live on Kick" allow="autoplay; fullscreen; picture-in-picture" loading="lazy"/>}
      </div>
